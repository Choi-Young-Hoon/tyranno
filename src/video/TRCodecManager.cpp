...
TRCodec* TRCodecManager::CreateCodec(CODEC_TYPE codec_type, TRCodecID& codec_id, TRError* error) {
    ...
    case CODEC_TYPE::DECODE_CODEC:
        ret_codec = CreateDecodeCodec(codec_id, error);
        break; 
    case CODEC_TYPE::ENCODE_CODEC:
        ret_codec = CreateEncodeCodec(codec_id, error);
        break;
    default:
...
TRCodec* TRCodecManager::CreateEncodeCodec(TRCodecID& codec_id, TRError* error) {
...
TRCodec* TRCodecManager::CreateDecodeCodec(TRCodecID& codec_id, TRError* error) {
